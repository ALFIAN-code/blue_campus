...
class NilaiPageMahasiswa extends StatefulWidget {
  NilaiPageMahasiswa({super.key});

  @override
  State<NilaiPageMahasiswa> createState() => _NilaiPageMahasiswaState();
}

class _NilaiPageMahasiswaState extends State<NilaiPageMahasiswa> {
